...
class DocumentsPreferencesPresenter extends PagePresenter
{
    ...
    public function createSettingsForm(): string
    {
        ...
        $formSettings = new FormPresenter('adm_preferences_form_settings', '../templates/preferences.plugin.documents.tpl', SecurityUtils::encodeUrl(ADMIDIO_URL . FOLDER_PLUGINS . DOC_PLUGIN_FOLDER . '/system/preferences.php', array(
            'mode' => 'save',
            'panel' => 'Settings'
        )), null, array(
    ...
    {
        $this->assignSmartyVariable('open_uninstall', SecurityUtils::encodeUrl(ADMIDIO_URL . FOLDER_PLUGINS . DOC_PLUGIN_FOLDER . '/system/uninstall.php'));
        $smarty = $this->getSmartyTemplate();
    ...
    public function show(): void
    {
        ...
        $this->addJavascript('
            ...
            function loadPreferencesPanel(panelId) {
                ...
                $.get("' . ADMIDIO_URL . FOLDER_PLUGINS . DOC_PLUGIN_FOLDER . '/system/preferences.php", {
                    mode: "html_form",
                    panel: panelId
            ...
            function initializePanelInteractions(panelId) {
                ...
                panelContainer.off("click", "#adm_link_check_update").on("click", "#adm_link_check_update", function(event) {
                    ...
                    $.get("' . ADMIDIO_URL . FOLDER_PLUGINS . DOC_PLUGIN_FOLDER . '/system/preferences.php", { mode: "update_check" }, function(htmlVersion) {
                ...
                panelContainer.off("click", "#link_directory_protection").on("click", "#link_directory_protection", function(event) {
                    ...
                    $.get("' . ADMIDIO_URL . FOLDER_PLUGINS . DOC_PLUGIN_FOLDER . '/system/preferences.php", { mode: "htaccess" }, function(statusText) {
