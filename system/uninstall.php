...
try {
    ...
    switch ($getMode) {
        case 'security_check':
            ...
            $page = PagePresenter::withHtmlIDAndHeadline('plg-documents-uninstall-html');
            $page->setTitle($title);
            $page->setHeadline($headline);

            $form = new FormPresenter('documents_uninstall__form', '../templates/uninstall.plugin.documents.tpl', '', $page, array(
                'type' => 'default',
                'method' => 'post',
                'setFocus' => false
            ));
        ...
        case 'uninst':
            ...
            try {
                ...
                // wenn die Tabelle nur Einträge dieses Plugins hatte, sollte sie jetzt leer sein und kann geloescht werden
